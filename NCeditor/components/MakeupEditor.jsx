...
export const MakeupEditor = ({ imageSrc, onApply, onCancel }) => {
    const canvasRef = useRef(null);
    const [activeBrush, setActiveBrush] = useState('lip');
