...
export const Camera: React.FC<CameraProps> = ({ onCapture, onClose }) => {
  ...
  const [isFlashing, setIsFlashing] = useState(false); // For shutter effect
  ...
  return (
    <div className="fixed inset-0 bg-black z-50 flex flex-col font-sans touch-none">
      {/* Shutter Flash */}
      <div className={`absolute inset-0 bg-white z-[60] pointer-events-none transition-opacity duration-150 ${isFlashing ? 'opacity-100' : 'opacity-0'}`} />
