import { FilterState, Point, HSLShift } from '../types';

// --- Color Conversion Helpers ---

export function rgbToHsl(r: number, g: number, b: number, out: Float32Array) {
    r /= 255; g /= 255; b /= 255;
...
export function hslToRgb(h: number, s: number, l: number, out: Uint8ClampedArray | number[], offset: number = 0) {
    let r, g, b;
...
export function processSelectiveAdjustments(data: Uint8ClampedArray, selective: FilterState['selective']) {
...
// --- LUT Helper ---
export function createSplineLUT(points: Point[]): Uint8Array {
